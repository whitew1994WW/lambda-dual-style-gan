...
class TestOptions:
    def __init__(self):
        ...
        self.parser.add_argument(
            "--content",
            type=str,
            default="./data/content/081680.jpg",
        ...
        self.parser.add_argument(
            "--style_id", type=int, default=53, help="the id of the style image"
        )
        self.parser.add_argument(
            "--truncation",
            type=float,
...
if __name__ == "__main__":
    ...
    save_name = args.name + "_%d_%s" % (
        args.style_id,
        os.path.basename(args.content).split(".")[0],
    )
    save_image(
        torchvision.utils.make_grid(
            F.adaptive_avg_pool2d(torch.cat(viz, dim=0), 256), 4, 2
        ).cpu(),
